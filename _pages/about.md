...
## News:
  * May 2026: Our tutorial on **Production-Grade Agentic Recommender Systems** has been accepted to SIGIR 2026 in Melbourne, Australia (Presentation this July). The GitHub page is now live — it also hosts materials from our RecSys 2025 tutorial: [https://agenticrecsys.github.io/](https://agenticrecsys.github.io/). If you're an industry researcher, engineer, or academic working on industrial agentic recommender systems, come join us. Instructors: **Reza Yousefi Maragheh** (Walmart Labs), Yashar Deljoo (Politecnico di Bari), Ben Coleman (DeepMind), Jason Cho (pretaskAI), and Chi Wang (AG2AI / DeepMind).
  * Dec 2025: Our workshop papers on **Multi-Agentic Evaluation for Recommender Systems** (two contributions) will be presented at NeurIPS 2025. Authors: **Reza Yousefi Maragheh et al.**
  * Dec 2025: Our workshop paper on **Text Generation with Implicit Feedback** will be presented at NeurIPS 2025. Authors: **Reza Yousefi Maragheh et al.**
  * Sep 2025: Content for Agentic RecSys Tutorial is available here: [https://agenticrecsys.github.io/](https://agenticrecsys.github.io/)
  ...
  * July 2025: A Review of our **ARAG** work is published by [Elvis Saravia](https://www.linkedin.com/posts/omarsar_agentic-rag-for-personalized-recommendation-activity-7347722779326070784-Qn_V/), [Quantum Zeitgeist](https://quantumzeitgeist.com/agentic-rag-improves-personalised-recommendations-with-enhanced-contextual-understanding/), and [Top Information Retrieval Papers of the Week](https://recsys.substack.com/p/towards-unified-ranking-foundation?open=false#%C2%A7arag-agentic-retrieval-augmented-generation-for-personalized-recommendation).
  * July 2025: Our paper with the title **ARAG: Agentic Retrieval Augmented Generation for Personalized Recommendation** will be presented in SIGIR, [Link](https://arxiv.org/abs/2506.21934),Authors: **Reza Yousefi Maragheh et al.**
  * July 2025: Our paper with the title **CAL-RAG: Retrieval-Augmented Multi-Agent Generation for Content-Aware Layout Design** will be presented in SIGIR, [Link](https://arxiv.org/abs/2506.21934) Authors: **Najmeh Forouzandemehr and Reza Yousefi Maragheh et al.**
  * July 2025: Our paper with the title **CARTS: Collaborative Agents for Recommendation Textual Summarization will be presented in ICML**, [Link](https://arxiv.org/abs/2506.17765) **Jiao Chen and Reza Yousefi Maragheh et al.**. The work is based on a recent user facing product launch.

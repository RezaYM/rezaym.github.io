...
* Set of *positive semidefinite matrices*: $$ \mathbb{S}<sub>+</sub> = \{X \in \mathbb{R}^{n \times n} \| X \succeq 0\}$$,
* Set of *positive matrices*: $$ \mathbb{S}<sub>++</sub> = \{X \in \mathbb{R}^{n \times n} \| X \succ 0\}$$,

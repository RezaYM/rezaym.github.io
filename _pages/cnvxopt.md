...
$$f^{-1}(S) = \{x \| f(x) \in S\}$$.
  ...
  * **Notes on an example**: Consider this Linear Matrix Inequality: $$x_1 A_1 + \dots + x_n A_n \preceq B$$, with $$A_i , B \in \mathbb{S}^m$$. Set of points $$x$$ satisfying this matrix inequality is convex. 

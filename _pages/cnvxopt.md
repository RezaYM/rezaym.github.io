...
$$f^{-1}(S) = \{x \| f(x) \in S\}$$.
  ...
  * **Notes on an example**: Consider this Linear Matrix Inequality: $$x_1 A_1 + \dots + x_n A_n \preceq B$$, with $$A_i , B \in \mathbb{S}^m$$. Prove that set of points $$x$$ satisfying this matrix inequality is convex. Think yourself then [check](https://rezaym.github.io/cnvxopt/In_text_Problem_1) your proof. 
